  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {    
      ...
      const authRes = await post("/authenticate", {
        ...
        role: "admin", // This matches your backend expectation
      });
      ...
      // STEP 2: Record login activity using your /log-activity endpoint
      ...
      if (activityRes?.status === "success") {
        // STEP 3: Save user info and update auth context
        const userData = {
          username: values.username,
          role: "admin" as const,
          user_id: user_id,
